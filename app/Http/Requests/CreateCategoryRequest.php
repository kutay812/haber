...
class CreateCategoryRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'main_categories_id.required' => 'Ana kategori id zorunludur.',
            'main_categories_id.integer' => 'Ana kategori id tam sayı olmalıdır.',
            'main_categories_id.exists' => 'Ana kategori bulunamadı.',
