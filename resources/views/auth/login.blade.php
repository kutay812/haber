...
<div class="bg-surface-container min-h-[60vh] flex items-center justify-center py-12 px-4">
    <div class="max-w-md w-full bg-surface p-8 border-[3px] border-primary flex flex-col gap-6 relative shadow-xl">
        ...
        <div class="text-center mb-2">
            <h2 class="font-display-sm text-display-sm text-primary uppercase mb-2">Giriş Yap</h2>
            <p class="font-body-md text-body-md text-on-surface-variant">Yorum yazmak ve profilinizi düzenlemek için giriş yapın</p>
        </div>
        ...
        <div class="text-center font-meta-data text-meta-data mt-4 pt-4 border-t border-outline-variant text-on-surface-variant">
            Hesabınız yok mu? 
            <a href="{{ route('register') }}" class="text-secondary hover:text-secondary-container transition-colors ml-1 font-bold">Kayıt Olun</a>
        </div>
