...
Route::get('/', function () {
    return view('welcome', [
        'kategoriler'   => \App\Models\Category::all(),
        'oneCikanlar'   => \App\Models\News::orderBy('created_at', 'desc')->take(3)->get(),
        'gundemler'     => \App\Models\News::orderBy('created_at', 'desc')->take(6)->get(),
        'sonDakikaList' => \App\Models\News::orderBy('created_at', 'desc')->take(5)->get(),
    ]);
})->name('welcome');
...
// Admin Login ve Şifre işlemleri
